...
Router.route('/app/placements', function(){
  ...
  this.render('breadcrumbPlacements', {
    to: 'breadcrumb'
  });
  this.render('contentIndicationsPlacements', {
    to: 'contentIndications'
  });

  this.render('contentPlacements');
},{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Router.route('/app/placements/:_id', function(){
  this.layout('applayout');
  this.render('breadcrumbPlacementDetails', {
    to: 'breadcrumb',
    data: function(){
      return Placements.findOne({_id: this.params._id});
    }
  });
  this.render('menuTitlePlacements', {
    to: 'menuTitle'
  ...
  this.render('contentIndicationsPlacementDetails', {
    to: 'contentIndications',
    data: function(){
      return Placements.findOne({_id: this.params._id});
    }
  });
  this.render('contentPlacementDetails',{
      data: function(){
        return Placements.findOne({_id: this.params._id});
      }
    });
...
Router.route('/app/visits', function(){
  ...
  this.render('breadcrumbVisits', {
    to: 'breadcrumb'
  });
  this.render('contentIndicationsVisits', {
    to: 'contentIndications'
  });

  this.render('contentVisits');
},{
...

Router.route('/app/visits/:_id', function(){
  this.layout('applayout');
  this.render('breadcrumbVisitDetails', {
    to: 'breadcrumb',
    data: function(){
      return Visits.findOne({_id: this.params._id});
    }
  });
  this.render('menuTitleVisits', {
    to: 'menuTitle'
  ...
  this.render('contentIndicationsVisitDetails', {
    to: 'contentIndications',
    data: function(){
      return Visits.findOne({_id: this.params._id});
    }
  });
  this.render('contentVisitDetails',{
      data: function(){
        return Visits.findOne({_id: this.params._id});
      }
    });
